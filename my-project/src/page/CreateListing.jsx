    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <input
          ...
          minLength="10"
          required
          className="w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white
        ...
        <div className="flex space-x-6 mb-6">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="w-full px-4 py-2 text-xl text-gray-300 bg-white border-gray-700 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-gray-600 text-center"
            />
          </div>
          <div>
